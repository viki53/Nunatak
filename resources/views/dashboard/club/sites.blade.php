...
<div class="columns-container">
	...
	<div class="column @can('create_site', $club) col-md-8 @endcan">
		<div class="card">
				...
				<div class="table-container">
					<table class="simple striped">
						<thead>
							<tr>
								<th>{{ __('Site') }}</th>
								<th class="text-center" style="max-width: 12rem">{{ __('Pages') }}</th>
								<th class="text-center" style="max-width: 9rem"></th>
							</tr>
						</thead>
						<tbody>
			...
			<div class="card-body">
				...
				<div class="form-group">
					...
					<div class="input-group">
						<div class="input-group-prepend show-xl">
						...
						<div class="input-group-append ellipsis show-xl">
